...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "душитель, дварфийское вино и дварфийский сироп. Она совершенно не выносит<accs> ящерицы.",
            "душитель, дварфийское вино и дварфийский сироп. Она совершенно не выносит ящериц.",
        ),
        (
            "употреблять <accs>  енот,  хек, дуриановая бормотуха, овсяная  мука и семена  амаранта пурпурного.  Он",
            "употреблять енота, хека, дуриановую бормотуху, овсяную муку и семена амаранта пурпурного.  Он",
        ),
        (
