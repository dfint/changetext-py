...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("В начале осени  <gent> 14, Factional Confederacy держать  соревнование с участием", "В начале осени 14 года Factional Confederacy держать  соревнование с участием"),
        ...
        ("Couple  <gent> Glimmers  в Oakgrasping как часть <gent>  Festival <gent> Driving.", "Couple of Glimmers  в Oakgrasping как часть Festival of Driving."),
        ...
        #     'возможности он предпочитает употреблять турнепс, ячменное вино и мука из фонио. Он совершенно не'
        # )
    ],
)
