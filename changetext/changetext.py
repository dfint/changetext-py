...
from .utils import inflect_collocation, custom_parse, is_adjective, any_in_tag, make_adjective, dict_ending_s, \
    get_gender, get_main_word_gender, inflect_adjective, inflect_noun, genitive_case_single_noun, genitive_case_list, \
    genitive_case, open_brackets
