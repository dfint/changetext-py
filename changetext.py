...
# feminine
    ...
    "корона":feminine,"перчатка":feminine,"Клетка":feminine,                        # duplicate дверь
...
# plural
    ...
    "Монеты":plural,"Блоки":plural,"Наконечники стрел":plural,
...
#дублируются сь и ль
    let_2={
        ...
        'во':'ва','со':'са','ст':'ста','ко':'ка','ия':'ий','хи':'хов','ые':'ых',
        'цы':'цы','ой':'ой','ки':'ки','ти':'ти',
...
def ChangeText(s):
#    print(re_13.search(s).group(0, 1, 2))
    if s in phrases:
        return phrases[s]
    elif re_1.search(s):
...
#    print(ChangeText("илистая глина лестница вверх"))
    ...
    print(ChangeText("Заснеженный густой овсяница Подъем"))
    print(ChangeText("Влажный илистая глина Стена")) 
    input()
