...
#    исключение
    ...
    'из хорошего':("из хорошего","из хорошего","из хорошего","из хорошего"),
    'из простого':("из простого","из простого","из простого","из простого"),
    'из мирского':("из мирского","из мирского","из мирского","из мирского"),
...
#если материал из двух слов
    ...
    if s_temp_sp[0:3]==['из', 'висмутовой', 'бронзы']:
