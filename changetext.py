...
# мастерская каменщика
    ...
    'Изготовить камень решетку':'Делать решетку из камня',
    ...
    'Изготовить камень ручную мельницу':'Делать ручную мельницу из камня',
...
# мастерская ремесленника
    ...
    'Делать шелк изделия':'Делать изделия из шелка',
...
#Стекловареннная печь
    ...
    'Изготовить зеленое стекло доспешная стойка':'Изготовить доспешную стойку из зеленого стекла',
    'Изготовить бесцветное стекло доспешная стойка':'Изготовить доспешную стойку из бесцветного стекла',
    'Изготовить хрусталь доспешная стойка':'Изготовить доспешную стойку из хрусталя',
    'Изготовить зеленое стекло статуя':'Изготовить статую из зеленого стекла',
    'Изготовить бесцветное стекло статуя':'Изготовить статую из бесцветного стекла',
    'Изготовить хрусталь статуя':'Изготовить статую из хрусталя',
    'Изготовить зеленое стекло оружейная стойка':'Изготовить оружейную стойку из зеленого стекла',
    'Изготовить бесцветное стекло оружейная стойка':'Изготовить оружейную стойку из бесцветного стекла',
    'Изготовить хрусталь оружейная стойка':'Изготовить оружейную стойку из хрусталя',
    'Делать гигантский зеленое стекло лезвие топора':'Делать гигантское  лезвие топора из зеленого стекла',
    'Делать гигантский бесцветное стекло лезвие топора':'Делать гигантское лезвие топора из бесцветного стекла',
    'Делать гигантский хрусталь лезвие топора':'Делать гигантское лезвие топора из хрусталя',
    'Делать большой, зазубренный зеленое стекло диск':'Делать большой, зазубренный диск из зеленого стекла',
    'Делать большой, зазубренный бесцветное стекло диск':'Делать большой, зазубренный диск из бесцветного стекла',
    'Делать большой, зазубренный хрусталь диск':'Делать большой, зазубренный диск из хрусталя',
    'Делать зеленое стекло Игрушка':'Делать игрушку из зеленого стекла',
    'Делать бесцветное стекло Игрушка':'Делать игрушку из бесцветного стекла',
    'Делать хрусталь Игрушка':'Делать игрушку из хрусталя',
    'Делать зеленое стекло Туба':'Делать тубу из зеленого стекла',
    'Делать бесцветное стекло Туба':'Делать тубу из бесцветного стекла',
    'Делать хрусталь Туба':'Делать тубу из хрусталя',
    'Изготовить зеленое стекло Решетка':'Изготовить решетку из зеленого стекла',
    'Изготовить бесцветное стекло Решетка':'Изготовить решетку из бесцветного стекла',
    'Изготовить хрусталь Решетка':'Изготовить решетку из хрусталя',
...
# masculine
    ...
    "амулет":masculine,"нагрудник":masculine,"Кубок":masculine,"Инструмент":masculine,
    ...
    "саркофаг":masculine,"ящик":masculine,"Костыль":masculine,"мемориал":masculine,
    "сундук":masculine,
...
# feminine
    ...
    "стойка":feminine,"решётка":feminine,
...
# plural
    ...
    "верёвки":plural,"кольчуги":plural,"шлемы":plural,
    ...
    "кровати":plural,"жернова":plural,"троны":plural,"стойки":plural,"сундуки":plural,
# самоцветы
# masculine
...
#дублируются сь и ль
    let_2={
        ...
        'сь':'си', 'ус':'ус', 'ий':'ого', 'ый':'ого', 'ви':'ви',
    ...
    let_3={
        ...
        'ной':'ной','чья':'чьей','вой':'вого','ень':'ня','ова':'овой',
        'шой':'шого','аус':'ауса','дой':'дого',
    }
...
def corr_item_14(s):
    ...
    if "частичный" in ''.join(hst.group(1).split(" ")):
        word=''.join(hst.group(1).split(" ")[1])
        s=s.replace(hst.group(1)+" "+hst.group(2), word+" "+hst.group(2)+" "+rod_pad(''.join(hst.group(1).split(" ")[0])))
    else:
        s=s.replace(hst.group(1)+" "+hst.group(2), hst.group(2)+" "+rod_pad(hst.group(1)))
    return(s.capitalize())
...
def corr_item_18(s):
    ...
    s=s=s.replace(hst.group(1), s_temp)
    return(s.capitalize())   
...
re_6 = re.compile(r'(^[(+*-«☼]*?)(\w+\s?\w+?)\s(из волокон|из шёлка|из шерсти|из кожи|из копыт|из кости|из рогов|из бивней|из панциря|из зубов)\s(\w+\s?\w+?\b)')
...
re_12 = re.compile(r'\((.+)\s(бочка|мешок)\s\((.+)\)(.+)?\)')
re_12_1 = re.compile(r'(.+)\s(из волокон|из шёлка|из шерсти|из кожи)')
re_13 = re.compile(r'(.+)\s(Подъем|Стена|Кластер|валун|склон|Пол Пещеры|пол|Лестница Вверх|Лестница Вниз|галька|деревце|лестница вверх|лестница вниз)\b')
re_13_1=re.compile(r'\b(Густой|Редкий)\s(.+)')
re_13_2 = re.compile(r'^[{]?(\w+\s?\w+?)\s(панцирь|скелет|искалеченный труп|останки|кость|кожа|шёлк|волокна|шерсть|мех|хвост|труп)\}?\b')
re_14=re.compile(r'\b(Делать|Изготовить|Делать\s?\w+?)\s(зеленое стекло|бесцветное стекло|хрусталь)\s(\w+)')
re_15 = re.compile(r"(^Кузница|^Делать|^Чеканить|^Изготовить)\s(из\s\w+)\s(\w+\s?\w+?\b)")
re_15_1 = re.compile(r"(^Кузница|^Делать|^Чеканить|^Изготовить)\s(из\s\w+\s\w+)\s(\w+\s?\w+?\b)")
...
#    print(ChangeText("Инкрустировать Предметы обстановки с трубчатый агат"))
#    print(ChangeText("Инкрустировать Снаряды с трубчатый агат"))
...
#    print(ChangeText("краснокрылый чёрный дрозд кожа"))
