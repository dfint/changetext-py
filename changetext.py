...
phrases = {
    ...
    'пряжа обувь':'обувь из пряжи',
    'шёлк обувь':'обувь из шёлка',
    ...
    'растительное волокно обувь':'обувь из растительного волокна',
...
# masculine
    ...
    "сундук":masculine,"головной убор":masculine,
...
# plural
    ...
    "перчатки":plural,"брюки":plural,"доспехи":plural,"щиты/баклеры":plural,
...
#дублируются сь и ль
    let_2={
        ...
        'сь':'си', 'ус':'ус', 'ий':'ого', 'ый':'ого', 'ви':'ви','ёр':'ра',
        ...
        'зе':'зе','бо':'бо','ёк':'ька','ия':'ии','пи':'пи','ще':'ща','ек':'ек',
        'ие':'их',
    }
...
re_19 = re.compile(r'(.+)\s(кожа|кость|волокно|шёлк)\b')
#re_20 = re.compile(r'(металл|кожа|пряжа|растительное волокно|дерево)\s\(.+)b')
############################################################################
def Init():
    # phrases['Test'] = 'Test'
    pass
...
def ChangeText(s):
    def Test(s): 
#   print(re_19.search(s).group(0, 1,2))
      if s in phrases:
          return phrases[s]
      elif re_1.search(s):
...
if __name__ == '__main__':
    ...
    print(ChangeText("из железа щитs/баклерs"))
