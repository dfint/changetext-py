...
re_13 = re.compile(r'(.+)\s(Подъем|Стена|Кластер|валун|склон|Пол Пещеры|пол|Лестница Вверх|Лестница Вниз|галька|деревце)\b')
...
def ChangeText(s):
#    print(re_15_1.search(s).group(0, 1, 2, 3))
    if s in phrases:
        return phrases[s]
    elif re_1.search(s):
...
#    print(ChangeText("Заснеженный густой овсяница Подъем"))
    print(ChangeText("росомаха скелет"))    
    print(ChangeText("росомаха частичный скелет"))
