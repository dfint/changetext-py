...
# неорганические камни минералы
    ...
    'из пудингового конгломерата':'',
    'из окаменелой древесины':'',
...
# plural
    ...
    "цереуса":plural, "ведроs":plural, "столы":plural, "гробы":plural,
    ...
    "мечи":plural,"слитки":plural,"шины":plural,"костыли":plural,"бочкаs":plural,
    "клеткаs":plural,"ульи":plural,"горшки":plural,"гнёзда":plural,"вёдра":plural,
...
# plural
    ...
    "алмазы":plural,"рубицеллы":plural,     
}
...
#выбор преметов
##############################################################################
items_chois={"приготовленные","рубленная","требуха","мясо","яйцо","кровь","сукровица","железы"}
...
if __name__ == '__main__':
    ...
    print(ChangeText("огранка конически багетт морионы"))
    print(ChangeText("одинарной огранки шерлы"))
    print(ChangeText("большой грушевидной огранки морион"))
    print(ChangeText("большой круглый лавандовый нефрит кабошон"))
    input()
