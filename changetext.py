...
if __name__ == '__main__':
    ...
    print(ChangeText("из сосны бочкаs"))# лишний пробел
    print(ChangeText("из сосны ведроs"))
    print(ChangeText("лама из кожи колчанs"))
    print(ChangeText("гусь из кожи рюкзакs"))
