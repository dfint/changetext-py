...
#   print(ChangeText("Изготовить из золота доспешная стойка"))
#    print(ChangeText("Ковать железный арбалет"))
    print(ChangeText("из висмутовой бронзы"))
